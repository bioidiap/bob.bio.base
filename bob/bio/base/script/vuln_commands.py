...
def gen_score_distr(mean_gen, mean_zei, mean_pa,
                    sigma_gen=1, sigma_zei=1, sigma_pa=1,
                    num_gen=5000, num_zei=5000, num_pa=5000):
...
def write_scores_to_file(neg_licit, pos_licit, spoof, filename):
  ...
  with open(filename, 'wt') as f:
    ...
    csv_writer.writerow(["bio_ref_reference_id", "probe_reference_id", "probe_key", "probe_attack_type", "score"])
